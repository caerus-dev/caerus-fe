    ...
    <footer className="border-t border-border/60 bg-card/20 backdrop-blur-sm">
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col items-center md:items-start gap-2.5 text-center md:text-left">
            <Link href="/" className="flex items-center gap-2.5 transition-opacity hover:opacity-90">
              <img src="/logo.svg" alt="Caerus Logo" className="h-7 w-auto" />
              <span className="text-xl font-bold tracking-tight">Caerus</span>
            </Link>
            <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
              Concurrency as a Service. Simplificando la coordinación y gestión de recursos concurrentes en sistemas distribuidos.
            </p>
          </div>

          {/* Clean, Working Navigation Links */}
        ...
        <div className="border-t border-border/40 mt-8 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted-foreground">
          <p>
            &copy; {new Date().getFullYear()} Caerus. Todos los derechos reservados.
          </p>
